...
#define _DUTY_NEU 1530    // [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1760                //[3062] 서보의 최대각도의 microseconds의 값
...
// Event periods
#define _INTERVAL_DIST 5   // [2635] 적외선센서 업데이트 주기
#define _INTERVAL_SERVO 5  // [2635] 서보 업데이트 주기
#define _INTERVAL_SERIAL 50  // [3070] 시리얼 플로터 갱신 속도
...
float ir_distance(void){ // return value unit: mm
    ...
    return f(val,66,372); // [3055] val 리턴
}
