...
float dist_min, dist_max, dist_raw, dist_past; // unit: mm
...
// get a distance reading from the USS
  ...
  if (dist_raw == 0) dist_raw = dist_past;
  else dist_past = dist_raw;

// output the read value to the serial port
  float a=255*(abs(dist_raw-200)/100); // 조건에 맞는 밝기 구현
